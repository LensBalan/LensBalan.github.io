    ...
    return (
        <div className="boas-vindas">
            ...
            <div className='resumo'>
                ...
                <p id='texto-resumo'className='fonte-texto' style={{marginBottom: '1vh', marginTop: '4vh'}}>Me formei Técnico em Informática pelo IFPR (2017–2021). Em seguida, passei no vestibular na primeira tentativa e ingressei no curso de Ciência. ewwwwwwwwwwwwwwww wwwdwfefegggggggggggggg gggggggggggggggggrererthgtht jtgrfeffuenfuenuneurejrwejwujrwuirjnwjrwruwjr iwjrwnrjwnruwnruwruw3 thuetugenurnw uejqiwjeiwjeiwuejriwjri</p>
