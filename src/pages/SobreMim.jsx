            ...
            <ScrollTela>
                <div className="general-infos">
                    ...
                    <ul className="lista-blog">
                        ...
                        <li>Gosto de ler; alguns livros que já li na vida e apreciei bastante são: a franquia The Witcher, Dora Doralina, Jantar Secreto, Verity (indicação da minha namorada) e O Cortiço. Acredito que ainda lerei muitos, no seguir da carruagem.</li>
                    </ul>
                    <p className="texto-info">Enfim, essas são algumas das minhas características mais pontuais. Tenho inúmeras outras. Caso queira me conhecer melhor, entre em contato comigo, marque uma entrevista, um fut, aquele vôlei de areia, algum evento, um game no sábado à noite… até quem sabe uma festa universitária.<br/><br/>Falou.<br/></p>
                </div>
            </ScrollTela>
